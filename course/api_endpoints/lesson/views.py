...
class CourseListAPIView(APIView):
    ...
    def get(self, request):
        # Faqat foydalanuvchining o'z kurslarini chiqarish
...
class LessonListAPIView(APIView):
    ...
    def get(self, request):
        # MUAMMO: Lesson modelida owner field bormi? 
        # Agar yo'q bo'lsa: Lesson.objects.filter(course__owner=request.user) deb yozing
